...
export async function gotoTransactions(user: User) {
...
export async function addTransaction(
  ...
  await user.type(screen.getByLabelText('Reference'), transaction.reference)
  await user.selectOptions(screen.getByLabelText('Account'), transaction.accountLabel)
  ...
  if (transaction.transactedAt) {
    const input = screen.getByLabelText('Transacted on')
    await user.clear(input)
    await user.type(input, transaction.transactedAt)
  }
